...
const cssFiles = ["./src/css/star_rating.css","./src/css/swiper-bundle.min.css","./src/css/calendar.css"];
const scssFiles = ["./src/scss/**/*.scss"];
const jsFiles = ["./src/js/products.js","./src/js/users.js","./src/js/main.js"];
const jsLibsFiles = ["./src/js/js_libs/star_rating.js","./src/js/js_libs/swiper-bundle.js"];
...
.on('error', function(err) {
  console.error('SVGO Error:', err.message);
  console.error('File:', err.file); // какой файл вызвал ошибку
  this.emit('end');
})
